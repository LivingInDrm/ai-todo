...
* **TC-View-02-Backlog 过滤**

  * **步骤**：新建无日期任务“读书”
  * **预期结果**：任务自动进入 Backlog；列表按 `created_ts ↓` 排序

* **TC-View-03-Done 30 天清理**
